...
<div class="row no-gutters">
    ...
    <div class="col-12 col-md-4">
        <div class="card">
            <div class="card-header">
                <h4 class="text-info">Add Department Admin</h4>
            </div>
            <div class="card-body">
                <form id="catAddForm">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="name" placeholder="Department Admin Name" id="add_name">
                        <span class="text-danger" id="nameError"></span>
                        <div id="response"></div>
                    </div>
                    <label for="">Email</label>
                    <div class="form-group">
                        <input type="text" class="form-control" name="code" placeholder="Department Admin Email" id="add_email">
                        <span class="text-danger" id="emailError"></span>
                        <div id="response"></div>
                    </div>
                    <label for=""> Password</label>
                    <div class="form-group">
                        <input type="text" class="form-control" name="credit" placeholder="Department Admin Pasword" id="add_pass">
                        <span class="text-danger" id="passwordError"></span>
                        <div id="response"></div>
                    </div>
                    <div class="form-group">
                        <button class="btn btn-block btn-success"><i class="fa fa-plus"></i> Add Department Admin</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="userCrudModal">Edit Department Admin</h4>
            ...
            <div class="modal-body">
                <form id="catUpdateForm" >
                    ...
                    <label for="">Department Admin Email</label>
                    <div class="form-group">
                        <input type="text" class="form-control" name="code" placeholder="Department Admin code" id="e_add_code_name">
...
<script type="text/javascript">
    ...
    function table_data_row(data) {
        ...
        function getAllDepartment(){
            axios.get("{{ route('admin.d-admin.fetch') }}")
            .then(function(res){
             //  console.log(res);
        ...
        $('body').on('click','#deleteRow',function (e) {
            e.preventDefault();
             let id = $(this).data('id')
            let url = base_path + '/admin/d-admin/' + id
        ...
        emailError.text('')
        passwordError.text('')
        axios.post("{{ route('admin.d-admin.store') }}", {
            name: $('#add_name').val(),
    ...
    //         setWaringMessage('Department Admin Code Already Exists!!')
    //         return null
    //        }
    //         getAllDepartment Admin();
